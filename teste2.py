...
with open('yoloDados/YoloNames.names') as f:
    ...
    # Carlos: aqui ele usa uma coisa chamada list compressions, no caso, f vai ser o arquivo, que pode ser escrito \\
    # Carlos: que pode ser entendido como uma lista de linhas, então isso pode ser trocado para um loop normal assim:
    '''
    labels = []
    for line in f:
        labels = line.strip()
...
#Carlos: pelo que eu entendi ess
